...
Imiê VARCHAR(20),
DataUr DATE,
CONSTRAINT PK_Znajomi PRIMARY KEY (Nazwisko,Imiê));
GO

ALTER TABLE Produkcja.Towary 
ADD CONSTRAINT U_NazwaTowaru UNIQUE (Nazwa);  

ALTER TABLE Produkcja.Czêœci
...
ALTER TABLE Produkcja.Czêœci
DROP CONSTRAINT FK__Czêœci__IDTowaru__108B795B; --ZA KAZDYM RAZEM ID BEDZIE INNE
GO
...
ALTER TABLE Produkcja.Czêœci
DROP CONSTRAINT FK__Czêœci__IDTowaru__20C1E124
...
ALTER TABLE Produkcja.Czêœci
ADD IDCzesci INT CONSTRAINT FK_Czesci REFERENCES Produkcja.Czêœci;
GO
